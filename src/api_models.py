...
class TourPOI(BaseModel):
    ...
    poi: str = Field(..., description="POI name")
    poi_id: Optional[str] = Field(None, description="POI identifier in kebab-case (for URL construction)")
    ...
    # Audio fields (runtime-only, generated by API)
    audio_url: Optional[str] = Field(None, description="URL to POI audio file")
    audio_available: Optional[bool] = Field(None, description="Whether audio is available for this POI")
